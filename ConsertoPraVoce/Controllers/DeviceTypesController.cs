...
namespace ConsertoPraVoce.Controllers
{
    public class DeviceTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Description")] DeviceType deviceType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Description")] DeviceType deviceType)
        {
            if (ModelState.IsValid)
            {
