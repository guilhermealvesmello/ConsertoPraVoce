...
namespace ConsertoPraVoce.Controllers
{
    public class PaymentMethodsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Description,Payments,Rate,Term")] PaymentMethod paymentMethod)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Description,Payments,Rate,Term")] PaymentMethod paymentMethod)
        {
            if (ModelState.IsValid)
            {
